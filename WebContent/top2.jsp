		...
		<nav class="navbar navbar-expand-sm bg-dark navbar-dark" id="nav">
			<div
				...
				<ul class="navbar-nav">
					<li class="nav-item active"><a class="nav-link"
						href="<%=myctx%>/admin/index.do">Home</a></li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">계정관리</a>
						<div class="dropdown-menu bg-dark">
							<a class="dropdown-item bg-dark"
								href="<%=myctx%>/admin/studentList.do" style="color: white">학생계정</a>
							<a class="dropdown-item bg-dark"
								href="<%=myctx%>/admin/profList.do" style="color: white">교수계정</a>
							<a class="dropdown-item bg-dark"
								href="<%=myctx%>/admin/adminList.do" style="color: white">관리자계정</a>
						</div></li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">요청관리</a>
						<div class="dropdown-menu bg-dark">
							<a class="dropdown-item bg-dark"
								href="<%=myctx%>/registerClass.do" style="color: white">휴학
								요청처리</a>
						</div></li>
					<li class="nav-item dropdown"><a class="nav-link"
						data-toggle="dropdown"
						href="<%=myctx%>/freeboardListForManager.do">게시판</a></li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">공지사항</a>
						<div class="dropdown-menu bg-dark">
							<a class="dropdown-item bg-dark"
								href="<%=myctx%>/admin/notice.do" style="color: white">공지사항
								글쓰기</a> <a class="dropdown-item bg-dark"
								href="<%=myctx%>/admin/noticeList.do" style="color: white">공지사항
								목록</a>
						</div></li>
					<li class="nav-item"><a class="nav-link"
						href="<%=myctx%>/admin/schedule.do">학사일정관리</a></li>
				</ul>
			...
			<div class="navbar-collapse collapse order-3 dual-collapse2">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item"><a class="nav-link">${mloginUser.mname }님
							로그인중</a></li>
					<li class="nav-item"><a class="nav-link"
						href="<%=myctx%>/admin/mypage.do">MYPAGE</a></li>
					<li class="nav-item"><a class="nav-link"
		...
		<div id="nav2">
			<nav class="navbar bg-dark navbar-dark">
				...
				<ul class="navbar-nav" style="flex-direction: row">
					<li class="nav-item active"><a class="nav-link"
						href="<%=myctx%>/admin/index.do">Home</a></li>
					<li class="nav-item pl-3"><a class="nav-link">${mloginUser.mname}님
							로그인중</a></li>
				...
				<div class="collapse navbar-collapse" id="collapsibleNavbar">
					<ul class="navbar-nav">
						...
						<li class="nav-item"><a class="nav-link"
							href="<%=myctx%>/admin/mypage.do">마이페이지</a></li>
						<li class="nav-item"><a class="nav-link"
							href="<%=myctx%>/admin/schedule.do">학사일정관리</a></li>
					</ul>
				</div>
