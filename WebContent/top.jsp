			...
			<div
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">수강신청</a>
						<div class="dropdown-menu bg-dark">
							<a class="dropdown-item bg-dark" style="color: white"
								href="<%=myctx%>/registerClass.do">수강신청</a> <a
								class="dropdown-item bg-dark"
								href="<%=myctx%>/checkregisterClass.do" style="color: white">수강신청
								확인</a> <a class="dropdown-item bg-dark"
								href="<%=myctx%>/CheckTimeTable.do" style="color: white">시간표
								확인</a>
						</div></li>
					<li class="nav-item"><a class="nav-link m1"
						href="<%=myctx%>/accessMyClass.do?m=m1">강의평가</a></li>
					<li class="nav-item"><a class="nav-link"
						href="<%=myctx%>/CheckGrade.do">성적확인</a></li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">휴/복학</a>
						<div class="dropdown-menu bg-dark">
							<a class="dropdown-item bg-dark" style="color: white"
								href="<%=myctx%>/registerRest.do">휴학신청</a> <a
								class="dropdown-item bg-dark"
								href="<%=myctx%>/checkregisterRest.do" style="color: white">신청확인</a>
							<a class="dropdown-item bg-dark" href="#" style="color: white">복학
								날짜 확인</a>
						</div></li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">게시판</a>
						<div class="dropdown-menu bg-dark">
							<a class="dropdown-item bg-dark" href="<%=myctx%>/freeboard.do"
								style="color: white">게시글 쓰기 </a> <a
								class="dropdown-item bg-dark" href="<%=myctx%>/freeboardlist.do"
								style="color: white">게시글 목록</a>
						</div></li>
					<li class="nav-item"><a class="nav-link"
						href="<%=myctx%>/student/index.do">공지사항</a></li>
				</ul>

			</div>
			<div class="navbar-collapse collapse order-3 dual-collapse2">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item"><a class="nav-link">${loginUser.sname }님
							로그인중</a></li>
					<li class="nav-item"><a class="nav-link"
		...
		<div id="nav2">
			<nav class="navbar bg-dark navbar-dark">
				...
				<ul class="navbar-nav" style="flex-direction: row">
					...
					<li class="nav-item pl-3"><a class="nav-link">${loginUser.sname }님
							로그인중</a></li>
					<li class="nav-item pl-3"><a class="nav-link" href="#">LOGOUT</a></li>
						...
						<li class="nav-item dropdown"><a
							...
							<div class="dropdown-menu bg-dark">
								<a class="dropdown-item bg-dark"
									href="<%=myctx%>/registerClass.do" style="color: white">수강신청</a>
								<a class="dropdown-item bg-dark" href="#" style="color: white">수강신청
									확인</a> <a class="dropdown-item bg-dark" href="#"
									style="color: white">시간표 확인</a>
							</div></li>
						<li class="nav-item"><a class="nav-link" href="#">강의평가</a></li>
						<li class="nav-item"><a class="nav-link" href="#">성적확인</a></li>
						<li class="nav-item dropdown"><a
							class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">게시판</a>
							<div class="dropdown-menu bg-dark">
								<a class="dropdown-item bg-dark" href="<%=myctx%>/freeboard.do"
									style="color: white">게시글 쓰기 </a> <a
									class="dropdown-item bg-dark"
									href="<%=myctx%>/freeboardlist.do" style="color: white">게시글
									목록</a>
							</div></li>
						<li class="nav-item dropdown"><a
							class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">공지사항</a>
							<div class="dropdown-menu bg-dark">
								<a class="dropdown-item bg-dark" href="<%=myctx%>/notice.do"
									style="color: white">공지사항 글쓰기</a> <a
									class="dropdown-item bg-dark" href="<%=myctx%>/noticelist.do"
									style="color: white">공지사항 목록</a>
							</div></li>
