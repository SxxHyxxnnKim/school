...
10
20">
						<h5 class="card-title text-center pt-3">${loginUser.sname}</h5>
						...
						<ul class="list-group">
							<li
								...
								${loginUser.major}<i class="fa fa-graduation-cap"></i>
							</li>
							<li
								class=" border-0 list-group-item d-flex justify-content-between align-items-center">
								${loginUser.semail }<i class="fa fa-envelope-o"></i>
							</li>
							<li
								class=" border-0 list-group-item d-flex justify-content-between align-items-center">
								${loginUser.sphone }<i class="fa fa-phone"></i>
							</li>
						</ul>
					</div>
					...
					<div class="col-md-12 mt-2 pt-1">
						...
						<div class="row">
							<div class="col-md-12 mt-3 d-block d-md-none">
								<a class="btn btn-outline-primary ml-5 mr-3 mb-4"
									href="<%=myctx%>/student/changeInfo.do">기본정보 변경<br>
						...
						<div class="d-none d-sm-none d-md-block">
							...
							<div class="row h-25 border m-1 mb-2"
								...
								<div class="col-md-3 pl-5 pt-5 mt-4" style="">
									<a class="btn btn-outline-primary btn-lg text-nowrap"
										href="<%=myctx%>/student/changePwd.do">수정</a>
								</div>
							</div>
							<c:if test="${loginUser.sstate eq -1}">
								<div class="row h-25 border m-1 mb-2"
									style="height: 200px !important">
									<div
										class="col-md-8 text-left text-lowercase mt-3 mb-2 pt-5 pl-4"
										style="">
										<h2 class="">탈퇴 전환하기</h2>
										<h6 class="">다시 홈페이지 이용이 가능해집니다.</h6>
									</div>
									<div class="col-md-3 pl-5 pt-5 mt-4" style="">
										<a class="btn btn-outline-primary btn-lg text-nowrap"
											href="<%=myctx%>/cancelDrop.do">전환</a>
									</div>
								</div>
							</c:if>
							<c:if test="${loginUser.sstate eq 0}">
								<div class="row h-25 border m-1 mb-2"
									style="height: 200px !important">
									<div
										class="col-md-8 text-left text-lowercase mt-3 mb-2 pt-5 pl-4"
										style="">
										<h2 class="">탈퇴하기</h2>
										<h6 class="" class="text-danger">홈페이지 이용이 불가합니다.</h6>
									</div>
									<div class="col-md-3 pl-5 pt-5 mt-4" style="">
										<a class="btn btn-outline-primary btn-lg text-nowrap"
											href="<%=myctx%>/drop.do">탈퇴</a>
									</div>
								</div>
							</c:if>
						</div>
