...
10
20">
						<h5 class="card-title text-center pt-3">${mloginUser.mname}</h5>
						...
						<ul class="list-group">
							<li
								...
								${mloginUser.memail }<i class="fa fa-envelope-o"></i>
							</li>
							<li
								class=" border-0 list-group-item d-flex justify-content-between align-items-center">
								${mloginUser.mphone }<i class="fa fa-phone"></i>
							</li>
						</ul>
					</div>
						...
						<div class="row">
							<div class="col-md-12 mt-3 d-block d-md-none">
								<a class="btn btn-outline-primary ml-5 mr-3 mb-4"
									href="<%=myctx%>/admin/changeInfo.do">기본정보 변경<br>
							...
							<div class="row h-25 border m-1 mb-2"
								...
								<div class="col-md-3 pl-5 pt-5 px-1 mt-4" style="">
									<a class="btn btn-outline-primary btn-lg text-nowrap"
										href="<%=myctx%>/admin/changeInfo.do">수정</a>
								</div>
							</div>
							<div class="row h-25 border m-1 mb-2"
								style="height: 200px !important">
								...
								<div class="col-md-3 pl-5 pt-5 mt-4" style="">
									<a class="btn btn-outline-primary btn-lg text-nowrap"
										href="<%=myctx%>/admin/changePwd.do">수정</a>
								</div>
							</div>
							<div class="row h-25 border m-1 mb-2"
								style="height: 200px !important">
