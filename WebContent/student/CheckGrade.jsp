...
<div class="container">
	<h1 style="text-size: 50px" class="text-center">성적 확인</h1>
	<div class="row">
		<table>
			<tr>
				<td><img class="pr-3" src="<%=myctx%>/images/star.png"
					style="vertical-align: middle;"></td>
				<td id="test"><label style="font-size: 40px">총학점: 4.5</label></td>
			</tr>
		</table>
	</div>
	<div class="row pt-5">
