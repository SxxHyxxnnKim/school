...
<div class="container">
	...
	<div class="row">
		<h3 class="text-secondary">강의명을 누르면 강의 평가 페이지로 이동합니다.</h3>
	</div>
...
<form id="accessF" action="accessClass.do" method="POST">
	<input type="hidden" id="accessSubject" name="accessSubject"> <input
		type="hidden" id="accessProf" name="accessProf">
</form>
