		...
		<nav class="navbar navbar-expand-sm bg-dark navbar-dark" id="nav">
			<div
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link"
						href="<%=myctx%>/prof/subList.do#nav" onclick="location.reload()">개설과목
							관리</a></li>
					<!-- 강의 확인 -->
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">강의
							확인</a>
						<div class="dropdown-menu bg-dark">
							<a class="dropdown-item bg-dark" style="color: white"
								href="<%=myctx%>/prof/checkClass.do#nav">수강신청 확인</a> <a
								class="dropdown-item bg-dark" style="color: white"
								href="<%=myctx%>/prof/evaluation.do#nav" onclick="history.go(0)">강의평가
								확인</a>
						</div></li>
					<!-- 성적 관리 -->
					<li class="nav-item"><a class="nav-link"
					...
					<!-- 공지사항 -->
					<li class="nav-item"><a class="nav-link"
						href="<%=myctx%>/prof/index.do">공지사항</a></li>
			...
			<div class="navbar-collapse collapse order-3 dual-collapse2">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item"><a class="nav-link" href="#">${ploginUser.pname }님
							로그인중..</a></li>
					<li class="nav-item"><a class="nav-link"
						href="<%=myctx%>/mypage.do#my">MYPAGE</a></li>
					<li class="nav-item"><a class="nav-link"
		...
		<div id="nav2">
			<nav class="navbar bg-dark navbar-dark">
				...
				<ul class="navbar-nav" style="flex-direction: row">
					<li class="nav-item active"><a class="nav-link"
						href="<%=myctx%>/prof/index.do">Home</a></li>
					<li class="nav-item pl-3 pr-5"><a class="nav-link" href="#">${ploginUser.pname }님
							로그인중..</a></li>
					<li class="nav-item"><a class="nav-link"
						href="<%=myctx%>/logout.do">LOGOUT</a></li>
				...
				<div class="collapse navbar-collapse" id="collapsibleNavbar">
					<ul class="navbar-nav">
						...
						<li class="nav-item"><a class="nav-link"
							href="<%=myctx%>/mypage.do#my">마이페이지</a></li>
					</ul>
				</div>
			</nav>
		</div>
