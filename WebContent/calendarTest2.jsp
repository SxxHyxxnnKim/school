			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="scheduleInsert.do" method="post">
						<table
							style="width: 100%; margin: 0 auto; border-collapse: separate; border-spacing: 0px 30px;">
							<tr>
								<td>일정명</td>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<c:forEach var="sch" items="${allSchedule}" varStatus="st">
						<table style="width: 100%; margin: 0 auto; border-collapse: separate; border-spacing: 0px 10px;">
...
<script type="text/javascript">
	...
	function scheduleEdit(num, cnt){
		...
		alert("num: "+editF.schnumE.value);
		alert("schcontents: "+editF.schcontentsE.value);
		alert("schstartdate: "+editF.schstartdateE.value);
		alert("schenddate: "+editF.schenddateE.value); */
