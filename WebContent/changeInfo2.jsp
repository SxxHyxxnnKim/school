<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="manager.domain.*, javax.servlet.http.*"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
<%
	String myctx = request.getContextPath();
HttpSession ses = request.getSession();
ManagerVO pvo = (ManagerVO) session.getAttribute("mloginUser");
String phone = pvo.getMphone();
					...
					<div class="card">
						<div class="card-body border-bottom" style="">
							...
							<div class="col-md-12 p-4">
								...
								<form name="frm" action="infoEditEnd2.do" method="POST"
									onsubmit="return check()">

									<div class="form-row">
										<div class="form-group col-md-12">
											<input type="text" class="form-control" id="form36"
												placeholder="Name" value="${mloginUser.mname }" readonly>
										</div>
									</div>
									<div class="row">
									...
									<div class="form-group">
										<input type="email" class="form-control" id="email"
											name="email" placeholder="Email" value="${mloginUser.memail }">
									</div>
