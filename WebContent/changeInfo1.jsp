<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="student.domain.*, javax.servlet.http.*"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
<%
	String myctx = request.getContextPath();
HttpSession ses = request.getSession();
StudentVO pvo = (StudentVO) session.getAttribute("loginUser");
String phone = pvo.getSphone();
					...
					<div class="card">
						<div class="card-body border-bottom" style="">
							...
							<div class="col-md-12 p-4">
								...
								<form name="frm" action="infoEditEnd1.do" method="POST"
									onsubmit="return check()">

									<div class="form-row">
										<div class="form-group col-md-12">
											<input type="" class="form-control" id="form36"
												placeholder="Name" value="${loginUser.sname }" readonly>
										</div>
									</div>
									<div class="row">
									...
									<div class="form-group">
										<input type="email" class="form-control" id="email"
											name="email" placeholder="Email" value="${loginUser.semail }">
									</div>
									<div class="form-group">
										<input type="text" class="form-control" id="form42"
											placeholder="Subject" value="${loginUser.major }" readonly>
									</div>
