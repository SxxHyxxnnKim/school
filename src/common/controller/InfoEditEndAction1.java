...
public class InfoEditEndAction1 extends AbstractAction {
	...
	public void execute(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		StudentVO loginUser = (StudentVO) ses.getAttribute("loginUser");

		String phone = ph1 + "-" + ph2 + "-" + ph3;
		int cnt = dao.editProfInfo(loginUser.getSnum(), phone, email);
