...
@WebServlet(urlPatterns = { "*.do" }, initParams = {
		@WebInitParam(name = "config", value = "C:\\CODING\\MYJava\\Util\\WorkSpace\\Final_Project\\Final_Project5\\WebContent\\WEB-INF\\command.properties") })
public class FrontController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	private HashMap<String, Object> cmdMap = new HashMap<>();
	// Commpand.properties�� �����Ǿ� �ִ� ������ �ؽ��ʿ� �ű� ����
